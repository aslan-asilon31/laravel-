...
class EmployeeController extends Controller
{
    ...
    {
        $records = Employee::with('productContent')->orderBy('created_at', 'desc')->paginate(20);
    ...
    {
        $products = Employee::with('productContent')->where('products.id',$id)->get();
    ...
    //     DB::beginTransaction();
    //     try {
    //         $products = Employee::with('productContent')->get();
    ...
    public function store(Request $request)
    {
        ...
        // Buat produk baru
        $product = Employee::create($validatedData);
    ...
    //         $product = Employee::create($validated);
    ...
    {
        try {
            $product = Employee::with('productContent')->findOrFail($id);
            return response()->json([
                "message" => "success",
                "data" => $product
            ]);
