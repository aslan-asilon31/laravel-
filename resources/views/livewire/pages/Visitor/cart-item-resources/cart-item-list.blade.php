          ...
          <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
            <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
              <div class="space-y-6">
                ...
                @forelse($cartItems as $item)
                    ...
                    <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                        ...
                        <img class="h-20 w-20 dark:hidden" src="{{ optional($item->product)->image_url ?? asset('frontend/assets/images/no-image.png') }}" alt="imac image" />
                        <img class="hidden h-20 w-20 dark:block" src="{{ optional($item->product)->image_url ?? asset('frontend/assets/images/no-image.png') }}" alt="imac image" />
                        </a>
                        ...
                        <div class="text-end md:order-4 md:w-32">
                            <p class="text-base font-bold text-gray-900 dark:text-white">Rp {{ number_format($item->amount, 0, ',', '.') }}</p>
                        </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            <button type="button" wire:click="removeCartItem('{{ $item->id }}')" class="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500">
              ...
              <div class="hidden xl:mt-8 xl:block">
                <h3 class="text-2xl font-semibold text-gray-900 dark:text-white">Rekomendasi Produk lain</h3>
                <div class="mt-6 grid grid-cols-3 gap-4 sm:mt-8">


                    @forelse ($productRecommendations as $productRecommendation)
                        <div class="space-y-6 overflow-hidden rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <div>
                            <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ $productRecommendation->product_name }}</a>
                            ...
                            <p class="text-lg font-bold leading-tight text-red-600 dark:text-red-500">Rp299</p>
                            </div>
              ...
              <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                ...
                <div class="space-y-4">
                  ...
                  <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                    ...
                    <dd class="text-base font-bold text-gray-900 dark:text-white">Rp{{ number_format($this->calculateFinalTotal(), 0, ',', '.') }}</dd>
                  </dl>
                </div>
      
                <a href="#" class="flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-dark hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 bordedr-lg shadow-lg">Proses Belanja</a>
