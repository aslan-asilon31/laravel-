<div>
    ...
    <button id="myCartDropdownButton1" data-dropdown-toggle="myCartDropdown1" type="button" class="inline-flex items-center rounded-lg justify-center p-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm font-medium leading-none text-gray-900 dark:text-white">
        ...
        <span class="hidden sm:flex">My Cart <p class="bg-blue-600 rounded text-xs ml-2 p-1 text-white"> {{ $this->loadCartItems1 }} </p> </span>
        ...
        @if ($cartItems) 
            ...
            <div class="grid grid-cols-2">   
                <div>
                    ...
                    <p class="mt-0.5 truncate text-sm font-normal text-gray-500 dark:text-gray-400">Rp {{ number_format($item->amount, 0, ',', '.') }}</p>
                </div>
